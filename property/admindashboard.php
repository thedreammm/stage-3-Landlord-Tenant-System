...
<body class="bg-gray-200">
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="w-1/5 bg-white shadow-lg">
            ...
            <nav class="mt-10">
                <a class="flex items-center py-2 px-8 bg-gray-200 text-gray-700 border-r-4 border-gray-700" href="admindashboard.php">
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <tbody class="bg-white">
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                    <div class="text-sm leading-5 text-gray-900">2023-04-01</div>
                                                </td>

                                                <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                                    <button class="text-indigo-600 hover:text-indigo-900 px-4 py-2 rounded" onclick="approveProperty()">Approve</button>
                                                    <button class="text-red-600 hover:text-red-900 px-4 py-2 rounded" onclick="denyProperty()">Deny</button>
                                                </td>
                                            </tr>
                                            <!-- More rows... -->
                                        </tbody>
    ...
    <script>
        ...
        function denyProperty() {
            // Logic to deny property
            let message = prompt("Please enter the reason for denial:", "Your property does not meet our guidelines.");
            if (message) {
                alert("Property denied. Reason: " + message);
            }
        }
    </script>
</body>
